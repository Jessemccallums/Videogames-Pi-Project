...
export default function HomeView () {
  ...
  const filteredGames = stategames
    .filter(game => {
      ...
      if (
        ...
        game.createdInDb !== (orderCreated === 'createdInDb')
      ) {
        passesFilter = false
      }
      ...
      if (
        busqueda &&
        !game.name.toLowerCase().includes(busqueda.toLowerCase())
      ) {
        passesFilter = false
      }
    ...
    <div className='contenido'>
      <div className='div'>
        <input
          ...
          className='searchbar'
        />
        <button onClick={hanlderGamesByName} className='buscadordejuegos'>
          Search
        </button>
      </div>
      <div className='filters'>
        <div className='filtradoscompleto'>
          <h3 className='filternames'>Filter by:</h3>
        ...
        <div className='filtradoscompleto'>
          <h3  className='filternames'>Ordering:</h3>
          <select
            name=''
            id=''
        ...
        <div className='filtradoscompleto'>
          <h3 className='filternames'>Genres:</h3>
          <select
            name=''
            id=''
        ...
        <div className='filtradoscompleto'>
          <h3  className='filternames'>Rating</h3>
          <select
            className='seleccionadores'
            onChange={handleChangeOrderByRating}
          >
            <option value='default'>Default</option>
        ...
        <div className='filtradoscompleto'>
          <h3 className='filternames'>Restore</h3>
      ...
      <div className='paginado'>
        <button
          className={`btnpage ${currentPage === 1 ? 'disabled-button' : ''}`}
          onClick={() => handlePrev()}
